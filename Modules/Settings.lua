...
local PerfSection = SettingsTab:AddSection("⚡ Performance & Battery")

PerfSection:AddToggle("🔋 OLED Saver (Black Screen)", function(state)
    if state then
...
PerfSection:AddButton("🔥 Boost FPS (Clear Textures)", function()
...
-- --- [ 2. SERVER SECTION ] ---
local ServerSection = SettingsTab:AddSection("🌐 Server Utilities")
...
-- --- [ 3. HISTORY LOGS (WindUI Paragraphs) ] ---
local History = SettingsTab:AddSection("📜 Vortex Chronicles")

-- Función para añadir párrafos fácilmente
local function Log(ver, desc)
    History:AddParagraph("["..ver.."] Update", desc)
end

-- PHASE 1
History:AddLabel("--- [ PHASE 1: GENESIS ] ---")
Log("v1.0", "Core UI Framework Initialization")
Log("v2.0", "Implemented TweenService Movement")
Log("v5.5", "Tsunami Distance Check Logic")

-- PHASE 2
History:AddLabel("--- [ PHASE 2: GOD SYSTEMS ] ---")
Log("v8.0", "Workspace Structure Analysis")
Log("v9.0", "Map Bypass Implementation")
Log("v10.0", "Client-Side VIP Access Injection")

-- PHASE 3
History:AddLabel("--- [ PHASE 3: STABILITY ] ---")
...
-- PHASE 4
History:AddLabel("--- [ PHASE 4: REVOLUTION ] ---")
Log("NEW", "Panic Mode (Survival First Protocol)")
Log("NEW", "Turbo-Interaction System")
Log("NEW", "Deep Search Scanner Algorithm")

-- PHASE 5
History:AddLabel("--- [ PHASE 5: ULTIMATE ] ---")
Log("EVENT", "UFO Coins Full Support")
Log("CORE", "Merged God Mode into Main Core")
Log("RELEASE", "Final Stable Build v31")

-- --- [ 4. CREDITS ] ---
local Credits = SettingsTab:AddSection("❤️ Credits")

Credits:AddParagraph("👑 Creator", "Daniel")
Credits:AddParagraph("🧠 AI Logic", "Gemini Premium")
Credits:AddParagraph("SPECIAL THANKS", "Gemini Premium Helped This Project ♥️")
Credits:AddParagraph("MOTTO", "Vortex On Top 🚀")
